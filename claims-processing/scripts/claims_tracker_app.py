...
<body>
    ...
    <p>Click below to simulate a new claim being processed (triggers Control‑M workflow).</p>
    <form method="POST">
    ...
    if request.method == "POST":
        try:
            ...
            if response.status_code == 200:
                message = "Claim submitted! Workflow ordered via API."
            else:
...
if __name__ == "__main__":
    ...
    if os.fork():
        os._exit(0)
    sys.stdout = open("/home/controlm/claims_tracker.log", "a")
